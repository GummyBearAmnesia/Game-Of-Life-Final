...
public class SimulatorView extends Application {
    ...
    public void simulate(int numGenerations) {
        new Thread(() -> {
            ...
            for (int gen = 1; gen <= numGenerations; gen++) {
                ...
                //the delay can be changed to speed up or slow down the simulation
                simulator.delay(500);
    ...
    public static void main(String args[]) {
        ...
        // Create an instance of SimulatorView
        ...
        // Read the number of generations from the user
        Scanner scanner = new Scanner(System.in);
        int generations = Integer.parseInt(scanner.nextLine());

        // Run the simulation
        Platform.runLater(() -> simulatorView.simulate(generations));
    }
